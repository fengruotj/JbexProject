...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <!-- /. ROW  -->
            <div class="row">
                <table id="dg" title="结伴而行信息" class="easyui-datagrid"
                       url="/queryJbexInfoPageByUser"
                       toolbar="#toolbar"
                       pagination= true
                       striped=true
                       nowrap=true
                ...
                <div id="toolbar">
                    <a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editUser()">编辑结伴而行信息</a>
                    <a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="destroyUser()">删除结伴而行信息</a>
                    <input id="search">
                </div>
